        ...
        <div className="main-content shadow sm:rounded-md sm:overflow-hidden md:flex-col w-auto justify-self-auto md:gap-6 m-5 p-4">
            ...
            {displayData &&
                displayData.options.map((option, i) => <span
                    className="flex flex-wrap justify-center m-4 py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-400 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
